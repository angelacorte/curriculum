...
\begin{adjustwidth}{}{-9cm}
    \cvsection{Education}
    \cvblock{Ph.D. Student in Computer Science Engineering}{University of Bologna}{11/2024 - ongoing}{Cesena, Italy}
    \textbf{Topic:} Advances in Collective Robotics through macro-programming\newline
...
\begin{adjustwidth}{}{-10cm}
    \cvsection{Academic Roles}

    \cvblock{ACSOS Publicity Chair}{{ACSOS 2026 \newline \scriptsize5th IEEE International Conference on Autonomic Computing and Self-Organizing Systems}}{7-11 Sep 2026}{Cesen, Italy}

    \divider

    \cvblock{FormaliSE Artifact Evaluation}{{FormaliSE 2026 \newline \scriptsize14th International Conference on Formal Methods in Software Engineering}}{12-13 April 2026}{Rio De Janeiro, Brazil}

    \divider

    \cvblock{DS-RT Local Chair Helper}{{DS-RT 2024 \newline \scriptsize28th International Symposium on Distributed Simulation and Real Time Applications}}{7-9 Oct 2024}{Urbino, Italy}
...
%    {\small \notesymbol \hspace{0.5em} Paper published to EUMAS 2023}\\
   ...
   \textbf{Keywords:} Aggregate Computing, Self-Organizing, Vascular Morphogenesis Controller
    ...
    Project Emerge is a modular, open-source toolchain for practical multi-robot demonstrations based on aggregate computing principles.\\ \smallskip
    \smallskip
    ...
    HarmoniKt is a microservices-based middleware solution designed to provide unified access to heterogeneous robot fleets in Industrial Internet of Things (IIoT) contexts.
    The project successfully integrates Boston Dynamics Spot (SPOT) and Mobile Industrial Robots (MiR) through a modular architecture that abstracts robot-specific functionalities behind standardized APIs.
    This project was made for the PhD Course ``Service Orchestration and Industrial IoT Platforms for Industry 4.0 and 5.0 environments ''.\\ \smallskip
    \textbf{Language:} Kotlin, Phyton\\
