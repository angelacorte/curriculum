...
\begin{adjustwidth}{}{-9cm}
    \cvsection{Education}
    \cvblock{Ph.D. Student in Computer Science}{University of Bologna}{11/2024 - now}{Cesena, Italy}
...
\begin{adjustwidth}{}{-9cm}
    ...
    \cvsubsection{\color{accent}Published}
    \nocite{*}
    \printbibliography[heading=none, check=pub]
    \divider
    \cvsubsection{\color{accent}Accepted -- {\small Available soon}}
